...
<head>
  ...
  {!! Html::style('public/admin/vendor/fontawesome-free/css/all.min.css') !!}
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
             ...
             @if(Auth::user()->photo != null )
                <img src="{{ url('/')}}/public/upload/member/{{ Auth::user()->photo }}" class="img-profile rounded-circle" alt="User Image">
              @else
